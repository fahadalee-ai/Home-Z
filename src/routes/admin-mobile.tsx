...
import { TabletSmartphone, ArrowLeft } from "lucide-react";
import { Logo } from "@/components/Logo";

export const Route = createFileRoute("/admin-mobile")({
  head: () => ({ meta: [{ title: "Admin Mobile App — Supreme Signatures" }] }),
  component: AdminMobilePlaceholder,
});

function AdminMobilePlaceholder() {
  return (
    <div className="mx-auto flex min-h-screen max-w-[440px] flex-col items-center justify-center px-8 text-center">
      ...
      <h1 className="font-display text-2xl font-bold text-white">
        Admin <span className="text-gradient-gold">Mobile App</span>
      </h1>
